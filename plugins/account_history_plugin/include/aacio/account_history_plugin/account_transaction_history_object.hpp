...
namespace std {
   ...
   template<>
   struct hash<aacio::chain::account_name>
   {
    size_t operator()( const aacio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( aacio::account_transaction_history_object, aacio::account_transaction_history_multi_index )

FC_REFLECT( aacio::account_transaction_history_object, (name)(transaction_id) )
