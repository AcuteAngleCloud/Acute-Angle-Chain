...
CHAINBASE_SET_INDEX_TYPE( aacio::account_control_history_object, aacio::account_control_history_multi_index )

FC_REFLECT( aacio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
