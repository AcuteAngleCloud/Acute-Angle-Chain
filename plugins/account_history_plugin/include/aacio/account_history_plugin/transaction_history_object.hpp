...
CHAINBASE_SET_INDEX_TYPE( aacio::transaction_history_object, aacio::transaction_history_multi_index )

FC_REFLECT( aacio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
