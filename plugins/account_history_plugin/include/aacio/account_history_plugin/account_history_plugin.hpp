...
FC_REFLECT(aacio::account_history_apis::empty, )
FC_REFLECT(aacio::account_history_apis::read_only::get_transaction_params, (transaction_id) )
FC_REFLECT(aacio::account_history_apis::read_only::get_transaction_results, (transaction_id)(transaction) )
FC_REFLECT(aacio::account_history_apis::read_only::get_transactions_params, (account_name)(skip_seq)(num_seq) )
FC_REFLECT(aacio::account_history_apis::read_only::ordered_transaction_results, (seq_num)(transaction_id)(transaction) )
FC_REFLECT(aacio::account_history_apis::read_only::get_transactions_results, (transactions)(time_limit_exceeded_error) )
FC_REFLECT(aacio::account_history_apis::read_only::get_key_accounts_params, (public_key) )
FC_REFLECT(aacio::account_history_apis::read_only::get_key_accounts_results, (account_names) )
FC_REFLECT(aacio::account_history_apis::read_only::get_controlled_accounts_params, (controlling_account) )
FC_REFLECT(aacio::account_history_apis::read_only::get_controlled_accounts_results, (controlled_accounts) )
