...
CHAINBASE_SET_INDEX_TYPE( aacio::public_key_history_object, aacio::public_key_history_multi_index )

FC_REFLECT( aacio::public_key_history_object, (public_key)(name)(permission) )
