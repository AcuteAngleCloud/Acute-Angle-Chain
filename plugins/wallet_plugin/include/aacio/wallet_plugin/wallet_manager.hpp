...
public:
   ...
   void set_aacio_key(const std::string& key) { aacio_key = key; }
   ...
   /// @param wif_key the WIF Private Key to import, e.g. 5Jgm1N6jp3iNbFM45kPtj66xmbqT9fSuVJgPWfnCSPgQanvW6mJ
...
private:
   ...
   std::string aacio_key = "5Jgm1N6jp3iNbFM45kPtj66xmbqT9fSuVJgPWfnCSPgQanvW6mJ";
};
