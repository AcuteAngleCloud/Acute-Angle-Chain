...
#include <aacio/wallet_plugin/wallet_api.hpp>
...
FC_REFLECT(create_account_params, (url)(creator)(newaccount)(owner)(active)(network)(cpu)(memory)(memorykb));
...
public:
   ...
   fc::variant easy_create_account(const std::string& url, const std::string& account, const std::string& key);
