   ...
   read_only::get_table_rows_result get_table_rows_ex( const read_only::get_table_rows_params& p, const abi_def& abi )const {
      ...
      try {
         ...
         try {
            ...
            try {
               auto symb = aacio::chain::symbol::from_string(p.scope);
               scope = symb.value();
            } catch( ... ) {
               try {
                  scope = ( aacio::chain::string_to_symbol( 0, p.scope.c_str() ) >> 8 );
               } catch( ... ) {
...
public:
   ...
   // return true if --skip-transaction-signatures passed to aacd
...
FC_REFLECT( aacio::chain_apis::read_only::get_currency_stats_result, (supply));

FC_REFLECT( aacio::chain_apis::read_only::get_account_results, (account_name)(permissions) )
FC_REFLECT( aacio::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(abi) )
FC_REFLECT( aacio::chain_apis::read_only::get_account_params, (account_name) )
FC_REFLECT( aacio::chain_apis::read_only::get_code_params, (account_name) )
...
FC_REFLECT( aacio::chain_apis::read_only::abi_json_to_bin_result, (binargs)(required_scope)(required_auth) )
FC_REFLECT( aacio::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( aacio::chain_apis::read_only::abi_bin_to_json_result, (args)(required_scope)(required_auth) )
