...
const char* error_advice_3030011 =  "You can try embedding aacio nonce action inside your transaction to ensure uniqueness.";
...
const char* error_advice_3120002 = R"=====(Public key should be encoded in base58 and starts with AAC prefix)=====";
...
const char* error_advice_3130001 =  "Ensure that you have \033[2maacio::chain_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130002 =  "Ensure that you have \033[2maacio::wallet_api_plugin\033[0m\033[32m added to your node's configuration!\n"\
...
const char* error_advice_3130003 =  "Ensure that you have \033[2maacio::account_history_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130004 =  "Ensure that you have \033[2maacio::net_api_plugin\033[0m\033[32m added to your node's configuration!";
...
bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   // aac recognized error code is from 3000000 to 3999999
