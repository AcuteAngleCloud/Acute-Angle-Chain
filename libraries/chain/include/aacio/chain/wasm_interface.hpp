...
namespace aacio { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against AACIO specific constraints
      ...
      private:
         ...
         friend class aacio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( aacio::chain::wasm_interface::vm_type, (wavm)(binaryen) )
