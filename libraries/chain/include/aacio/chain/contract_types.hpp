...
FC_REFLECT( aacio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( aacio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( aacio::chain::setabi                           , (account)(abi) )
FC_REFLECT( aacio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( aacio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( aacio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( aacio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( aacio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( aacio::chain::onerror                          , (sender_id)(sent_trx) )
