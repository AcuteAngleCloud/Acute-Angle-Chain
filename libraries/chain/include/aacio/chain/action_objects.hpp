...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::action_permission_object, aacio::chain::action_permission_index)

FC_REFLECT(aacio::chain::action_permission_object, (id)(owner)(owner_permission)(scope_permission) )
