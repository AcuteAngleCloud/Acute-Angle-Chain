...
FC_REFLECT(aacio::chain::block_header, (previous)(timestamp)
           (transaction_mroot)(action_mroot)(block_mroot)
           (producer)(schedule_version)(new_producers))

FC_REFLECT_DERIVED(aacio::chain::signed_block_header, (aacio::chain::block_header), (producer_signature))
FC_REFLECT( aacio::chain::shard_lock, (account)(scope))
FC_REFLECT( aacio::chain::shard_summary, (read_locks)(write_locks)(transactions))
FC_REFLECT( aacio::chain::region_summary, (region)(cycles_summary) )
FC_REFLECT_DERIVED(aacio::chain::signed_block_summary, (aacio::chain::signed_block_header), (regions))
FC_REFLECT_DERIVED(aacio::chain::signed_block, (aacio::chain::signed_block_summary), (input_transactions))
