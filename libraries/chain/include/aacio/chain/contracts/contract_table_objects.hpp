...
#include <aacio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::table_id_object, aacio::chain::contracts::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::key_value_object, aacio::chain::contracts::key_value_index)

CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::index64_object, aacio::chain::contracts::index64_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::index128_object, aacio::chain::contracts::index128_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::index256_object, aacio::chain::contracts::index256_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::contracts::index_double_object, aacio::chain::contracts::index_double_index)

FC_REFLECT(aacio::chain::contracts::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(aacio::chain::contracts::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
