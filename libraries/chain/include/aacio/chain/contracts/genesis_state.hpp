...
#include <aacio/chain/immutable_chain_parameters.hpp>
...
struct genesis_state_type {
   ...
   public_key_type                          initial_key = fc::variant("AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55").as<public_key_type>();
...
FC_REFLECT(aacio::chain::contracts::genesis_state_type,
