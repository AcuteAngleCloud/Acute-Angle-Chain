...
using action_name    = aacio::chain::action_name;
...
FC_REFLECT( aacio::chain::contracts::type_def                         , (new_type_name)(type) )
FC_REFLECT( aacio::chain::contracts::field_def                        , (name)(type) )
FC_REFLECT( aacio::chain::contracts::struct_def                       , (name)(base)(fields) )
FC_REFLECT( aacio::chain::contracts::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( aacio::chain::contracts::clause_pair                      , (id)(body) )
FC_REFLECT( aacio::chain::contracts::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( aacio::chain::contracts::abi_def                          , (types)(structs)(actions)(tables)(clauses) )

FC_REFLECT( aacio::chain::contracts::newaccount                       , (creator)(name)(owner)(active)(recovery) )
FC_REFLECT( aacio::chain::contracts::setcode                          , (account)(vmtype)(vmversion)(code) ) //abi
FC_REFLECT( aacio::chain::contracts::setabi                           , (account)(abi) )
FC_REFLECT( aacio::chain::contracts::updateauth                       , (account)(permission)(parent)(data)(delay) )
FC_REFLECT( aacio::chain::contracts::deleteauth                       , (account)(permission) )
FC_REFLECT( aacio::chain::contracts::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( aacio::chain::contracts::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( aacio::chain::contracts::postrecovery                     , (account)(data)(memo) )
FC_REFLECT( aacio::chain::contracts::passrecovery                     , (account) )
FC_REFLECT( aacio::chain::contracts::vetorecovery                     , (account) )
FC_REFLECT( aacio::chain::contracts::canceldelay                      , (trx_id) )
