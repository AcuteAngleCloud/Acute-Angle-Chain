...
#include <aacio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::global_property_object, aacio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::dynamic_global_property_object,
                         aacio::chain::dynamic_global_property_multi_index)

FC_REFLECT(aacio::chain::dynamic_global_property_object,
           (head_block_number)
           (head_block_id)
           (time)
           (current_producer)
...
FC_REFLECT(aacio::chain::global_property_object,
           (configuration)
           (active_producers)
          )
