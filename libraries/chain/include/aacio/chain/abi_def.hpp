...
abi_def aacio_contract_abi(const abi_def& aacio_system_abi);
vector<type_def> common_type_defs();

} } /// namespace aacio::chain

FC_REFLECT( aacio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( aacio::chain::field_def                        , (name)(type) )
FC_REFLECT( aacio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( aacio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( aacio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( aacio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( aacio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( aacio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
