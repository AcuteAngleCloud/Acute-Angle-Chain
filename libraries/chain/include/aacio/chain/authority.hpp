...
FC_REFLECT(aacio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(aacio::chain::key_weight, (key)(weight) )
FC_REFLECT(aacio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(aacio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(aacio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
