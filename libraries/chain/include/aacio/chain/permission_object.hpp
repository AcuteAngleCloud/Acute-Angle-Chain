...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::permission_object, aacio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::permission_usage_object, aacio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<aacio::chain::permission_object>, (_id))
FC_REFLECT(aacio::chain::permission_object, (id)(owner)(parent)(name)(auth)(last_updated)(delay))

FC_REFLECT(chainbase::oid<aacio::chain::permission_usage_object>, (_id))
FC_REFLECT(aacio::chain::permission_usage_object, (id)(account)(permission)(last_used))
