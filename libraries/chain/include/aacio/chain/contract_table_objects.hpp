...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::table_id_object, aacio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::key_value_object, aacio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(aacio::chain::index64_object, aacio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::index128_object, aacio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::index256_object, aacio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::index_double_object, aacio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(aacio::chain::index_long_double_object, aacio::chain::index_long_double_index)

FC_REFLECT(aacio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(aacio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
