...
CHAINBASE_SET_INDEX_TYPE(aacio::chain::permission_link_object, aacio::chain::permission_link_index)

FC_REFLECT(aacio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
