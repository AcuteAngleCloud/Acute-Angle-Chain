...
class privileged_api : public context_aware_api {
   public:
      ...
      void set_active_producers( array_ptr<char> packed_producer_schedule, size_t datalen) {
         ...
         AAC_ASSERT(psch.producers.size() == unique_producers.size(), wasm_execution_error, "duplicate producer name in producer schedule");
...
class system_api : public context_aware_api {
   public:
      ...
      void aacio_assert(bool condition, null_terminated_ptr str) {
         if( !condition ) {
