...
BOOST_AUTO_TEST_CASE(test_k1) try {
   auto private_key_string = std::string("5KWg9t3fkjSsVavTMuMcS4H5jexieMpVjMPxKtD9i1X7pLpegnY");
   auto expected_public_key = std::string("AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD");
