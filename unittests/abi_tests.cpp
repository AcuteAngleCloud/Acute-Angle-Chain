...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> optional<abi_serializer> {
      return abi_serializer(aacio_contract_abi(abi));
   };
}
...
{ try {
   ...
   abi_serializer abis(aacio_contract_abi(abi));
   abis.validate();
...
{ try {
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD",
      "publickey_arr" :  ["AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD","AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD","AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD", "weight":"100"},
      "keyweight_arr": [{"key":"AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD", "weight":"100"},{"key":"AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD", "weight":100},{"key":"AAC8VzFaGUEZBUXhEa6gkYhUgTifNfgx2XU9mFQbWz41MtTaZMyQD", "weight":200}],
...
{ try {
   ...
   abi_serializer abis(aacio_contract_abi(abi_def()));
...
{ try {
   ...
   abi_serializer abis(aacio_contract_abi(v.as<abi_def>()));
