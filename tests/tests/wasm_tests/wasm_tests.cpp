...
{ try {
      ...
      {
         aacio::chain::signed_transaction txn;
         txn.scope = {"currency"};
         txn.messages.resize(1);
         txn.messages[0].code = config::aac_contract_name;
      ...
      aacio::chain::signed_transaction txn2;
...
{ try {
   ...
   aacio::chain::signed_transaction txn3;
   ...
   aacio::chain::signed_transaction txn4;
   ...
   aacio::chain::signed_transaction txn11;
   ...
   aacio::chain::signed_transaction txn12;
   ...
   aacio::chain::signed_transaction txn13;
   ...
   aacio::chain::signed_transaction txn14;
   ...
   aacio::chain::signed_transaction txn15;
   ...
   aacio::chain::signed_transaction txn21;
   ...
   aacio::chain::signed_transaction txn22;
   ...
   aacio::chain::signed_transaction txn23;
   ...
   aacio::chain::signed_transaction txn24;
   ...
   aacio::chain::signed_transaction txn25;
