...
#include <aacio/abi_generator/abi_generator.hpp>
...
auto get_resolver(const contracts::abi_def& abi = contracts::abi_def())
{
   return [&abi](const account_name &name) -> optional<contracts::abi_serializer> {
      return abi_serializer(chain_initializer::aac_contract_abi(abi));
   };
}
...
{ try {
   ...
   abi_serializer abis(chain_initializer::aac_contract_abi(abi));
   abis.validate();
...
using namespace aacio::tests::config;

struct abi_gen_helper {

  abi_gen_helper() {}

  static bool is_abi_generation_exception(const aacio::abi_generation_exception& e) { return true; };

  bool generate_abi(const char* source, const char* abi, bool opt_sfs=false) {

    std::string include_param = std::string("-I") + aaciolib_path;
    std::string pfr_include_param = std::string("-I") + pfr_include_path;
    std::string boost_include_param = std::string("-I") + boost_include_path;
    std::string stdcpp_include_param = std::string("-I") + aaciolib_path + "/libc++/upstream/include";
    std::string stdc_include_param = std::string("-I") + aaciolib_path +  "/musl/upstream/include";
    ...
    bool res = runToolOnCodeWithArgs(new find_aacio_abi_macro_action(contract, actions, ""), source,
    ...
    abi_serializer(chain_initializer::aac_contract_abi(output)).validate();
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, "{}"), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(abigen_vector_multidimension, ""), aacio::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
BOOST_FIXTURE_TEST_CASE(abgigen_aacioabi_macro, abi_gen_helper)
{ try {

   const char* abgigen_aacioabi_macro = R"=====(
      ...
      struct hello : public aacio::contract {
        public:
   ...
   const char* abgigen_aacioabi_macro_abi = R"=====(
   {
     "types": [],
     "structs": [{
         "name": "hi",
   ...
   BOOST_TEST( generate_abi(abgigen_aacioabi_macro, abgigen_aacioabi_macro_abi) == true );
...
{ try {
   ...
   auto abi = chain_initializer::aac_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55",
      "publickey_arr" :  ["AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55","AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55","AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55"],
      "asset"         : "100.0000 AAC",
      "asset_arr"     : ["100.0000 AAC","100.0000 AAC"],

      "string"            : "ola ke ase",
      "string_arr"        : ["ola ke ase","ola ke desi"],
      "time"              : "2021-12-20T15:30",
      "time_arr"          : ["2021-12-20T15:30","2021-12-20T15:31"],
      "signature"         : "AACJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U",
      "signature_arr"     : ["AACJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U","AACJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
      ...
      "strx": {
        ...
        "expiration":"2021-12-20T15:30",
        "region": "1",
        "signatures" : ["AACJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
      ...
      "keyweight": {"key":"AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55", "weight":"100"},
      "keyweight_arr": [{"key":"AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55", "weight":"100"},{"key":"AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55", "weight":100},{"key":"AAC84snobCGtpQvTTfVaxvMuxGDd4p2LhtQhbWX1yWAU5yt4tiB55", "weight":200}],
...
{ try {
   ...
   auto abi = chain_initializer::aac_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
   abi_serializer abis(abi);
...
{ try {
   ...
   abi_serializer abis(chain_initializer::aac_contract_abi(abi_def()));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "data" : {
        ...
        "keys" : [ {"key" : "AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "AAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)updateauth.data.keys[0].key);
   BOOST_TEST(57005u == updateauth.data.keys[0].weight);
   BOOST_TEST("AAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)updateauth.data.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.owner.keys[0].key);
   BOOST_TEST(57005u == newaccount.owner.keys[0].weight);
   BOOST_TEST("AAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.owner.keys[1].key);
   ...
   BOOST_TEST("AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.active.keys[0].key);
   BOOST_TEST(57005u == newaccount.active.keys[0].weight);
   BOOST_TEST("AAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.active.keys[1].key);
   ...
   BOOST_TEST("AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.recovery.keys[0].key);
   BOOST_TEST(57005u == newaccount.recovery.keys[0].weight);
   BOOST_TEST("AAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.recovery.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("AAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)postrecovery.data.keys[0].key);
...
{ try {
   ...
   auto abi = chain_initializer::aac_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
