...
{ try {
   ...
   constexpr auto key3 = "5Jgm1N6jp3iNbFM45kPtj66xmbqT9fSuVJgPWfnCSPgQanvW6mJ"; // aacio key
   ...
   // aacio key is imported automatically when a wallet is created
