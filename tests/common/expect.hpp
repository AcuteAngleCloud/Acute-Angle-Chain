...
namespace aacio { namespace test {
...
#define EXPECT_3(P, E, T) aacio::test::expect<P>(E,T,"EXPECT<" #P ">(" #E "," #T ")")
#define EXPECT_2(E, T) aacio::test::expect(E,T,"EXPECT(" #E "," #T ")")
#define EXPECT_1(E) aacio::test::expect(E,"EXPECT(" #E ")")
