...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      AACLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      AACLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      AACLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      AACLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      AACLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      AACLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef aacio::multi_index< games_account, game> games;
}
/// @}
