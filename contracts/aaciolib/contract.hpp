 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every AACIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for AACIO contract.
 * @details %Base class for AACIO contract. %A new contract should derive from this class, so it can make use of AACIO_ABI macro.
 */
class contract {
   public:
      /**
