   ...
   class generic_currency {
      public:
          ...
          ACTION( code, issue ) {
             ...
             AACLIB_SERIALIZE( issue, (to)(quantity) )
          };
          ...
          ACTION( code, transfer ) {
             ...
             friend DataStream& operator >> ( DataStream& ds, transfer& t ){
                ...
                aacio_assert( t.quantity.symbol== token_type::symbol, "unexpected asset type" );
                return ds;
             }
          };
          ...
          struct transfer_memo : public transfer {
             ...
             AACLIB_SERIALIZE_DERIVED( transfer_memo, transfer, (memo) )
          };
          ...
          struct account {
             ...
             AACLIB_SERIALIZE( account, (balance)(symbol) )
          };
          ...
          struct currency_stats {
             ...
             AACLIB_SERIALIZE( currency_stats, (supply)(symbol) )
          };
           ...
           */
          typedef aacio::multi_index<accounts_table_name, account> accounts;
          typedef aacio::multi_index<stats_table_name, currency_stats> stats;
         ...
         static void apply( account_name c, action_name act) {
            aacio::dispatch<generic_currency, transfer, issue>(c,act);
         }
   };
