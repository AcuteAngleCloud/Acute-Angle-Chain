   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { aacio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { aacio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            aacio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return aacio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline aacio::datastream<Stream>& operator>> (aacio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline aacio::datastream<Stream>& operator<< (aacio::datastream<Stream>& ds, const optional& op)
         {
