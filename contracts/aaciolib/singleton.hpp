...
namespace  aacio {
    ...
    *  @brief Defines AACIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         AACLIB_SERIALIZE( row, (value) )
      };

      typedef aacio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            aacio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
