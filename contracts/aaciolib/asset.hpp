...
namespace aacio {
   ...
   #define S(P,X) ::aacio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      AACLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
      ...
      AACLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
   ...
   struct asset {
      ...
      explicit asset( int64_t a = 0, symbol_name s = S(4,AAC))
      :amount(a),symbol{s}
      {
