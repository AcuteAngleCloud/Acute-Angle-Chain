 ...
 *  aacio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  aacio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  aacio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  aacio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  aac_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  aacio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
