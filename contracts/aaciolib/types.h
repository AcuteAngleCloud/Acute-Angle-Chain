 ...
 * @details AACIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief AACIO Signature
 * @details AACIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of AACIO Transaction Id
 * @details Type of AACIO Transaction Id. It is 256-bit hash
 */
