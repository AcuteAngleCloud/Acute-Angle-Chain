...
namespace aacio {
   ...
   struct blockchain_parameters {
      ...
      AACLIB_SERIALIZE( blockchain_parameters,
   ...
   struct producer_key {
      ...
      AACLIB_SERIALIZE( producer_key, (producer_name)(block_signing_key) )
   };
   ...
   struct producer_schedule {
      ...
      AACLIB_SERIALIZE( producer_schedule, (version)(producers) )
   };
