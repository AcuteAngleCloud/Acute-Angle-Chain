...
namespace aaciosystem {
   ...
   const double   reward_rate           = 0.60;             // 60%
   const double   reward_perblock_rate  = 0.20;             // 20%
   const double   reward_standby_rate   = 0.40;             // 40%
   const double   reward_user_vote_rate = 0.40;             // 40%
