...
#include <aaciolib/public_key.hpp>
...
namespace aaciosystem {
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      AACLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      AACLIB_SERIALIZE(block_header, (timestamp)(producer)(confirmed)(previous)(transaction_mroot)(action_mroot)
    ...
    */
   class native : public aacio::contract {
      public:

         using aacio::contract::contract;
