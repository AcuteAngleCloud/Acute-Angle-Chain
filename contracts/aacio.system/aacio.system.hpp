...
namespace aaciosystem {
   ...
   typedef aacio::multi_index< N(namebids), name_bid,
   ...
   struct producer_info {
      ...
      aacio::public_key     producer_key; /// a packed public key object
      bool                  is_active = true;
      std::string           url;
   ...
   typedef aacio::multi_index< N(producers), producer_info,
                               indexed_by<N(prototalvote), const_mem_fun<producer_info, double, &producer_info::by_votes>  >
                               >  producers_table;

   typedef aacio::singleton<N(global), aacio_global_state> global_state_singleton;
   ...
   class system_contract : public native {
      ...
      public:
         ...
         void setparams( const aacio::blockchain_parameters& params );
