      ...
      public:
        ...
        using identity_base::identity_base;
         ...
         void create( const account_name creator, const uint64_t identity ) {
            ...
            aacio_assert( identity != 0, "identity=0 is not allowed" );
                               ...
                               const vector<certvalue>& values )
         {
            ...
            idents_table t( _self, _self );
            aacio_assert( t.find( identity ) != t.end(), "identity does not exist" );
...
AACIO_ABI( identity::contract, (create)(certprop)(settrust) );
