   ...
   class contract {
      public:
         ...
         struct get_owner_for_identity : public action_meta< code, N(getowner) >
         {
            ...
            AACLIB_SERIALIZE( get_owner_for_identity, (identity) )
         };
         ...
         struct get_identity_for_account : public action_meta< code, N(getidentity) >
         {
            ...
            AACLIB_SERIALIZE( get_identity_for_account, (account) )
         };
         ...
         static void apply( uint64_t receiver, account_name c, action_name act) {
            if( code == N(identitytest) ) {
              if ( act == N(getowner) ) {
                contract::on( receiver, aacio::unpack_action_data<get_owner_for_identity>() );
              } else if ( act == N(getidentity) ) {
                contract::on( receiver, aacio::unpack_action_data<get_identity_for_account>() );
              }
            }
         }
