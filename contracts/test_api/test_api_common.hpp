...
struct u128_action {
  ...
  AACLIB_SERIALIZE( u128_action, (values) )
};
...
struct dtt_action {
   ...
   AACLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   AACLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
