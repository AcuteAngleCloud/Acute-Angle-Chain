...
namespace aacio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         aacio_assert( interest_shares >= 0, "underflow" );
         aacio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      AACLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         AACLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      AACLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef aacio::multi_index<N(markets), exchange_state> markets;
